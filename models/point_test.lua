...
function TestPoint.test_new()
  ...
  luaunit.assert_true(point.isInstanceOf and point:isInstanceOf(Point))
...
function TestPoint.test_translate()
  ...
  luaunit.assert_true(translated_point.isInstanceOf
    and translated_point:isInstanceOf(Point))
...
function TestPoint.test_scale()
  ...
  luaunit.assert_true(scaled_point.isInstanceOf
    and scaled_point:isInstanceOf(Point))
