...
function TestPoint.test_new()
  ...
  luaunit.assert_true(checks.is_instance(point, Point))
...
function TestPoint.test_translate()
  ...
  luaunit.assert_true(checks.is_instance(translated_point, Point))
...
function TestPoint.test_scale()
  ...
  luaunit.assert_true(checks.is_instance(scaled_point, Point))
